<?php
    ...
    // Redirect admin/moderator users to dashboard
        ...
        <main>
            <?php if (isLoggedIn()): ?>
                ...
                <div class="page-actions">
                    <a href="calendar.php" class="subtle-link"><i class="far fa-calendar-alt"></i> View Calendar</a>
                </div>
                ...
                <?php else: ?>
                    <div class="no-events modern">
                        ...
                        <p>
                            Visit the <a href="calendar.php">calendar</a> to view and manage your events.
                        </p>
                    </div>
                <?php endif; ?>
<?php else: ?>
